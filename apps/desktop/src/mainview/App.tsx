    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-500 to-purple-600 text-gray-900">
      <div className="container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="bg-white rounded-xl shadow-xl p-8 mb-8">
          ...
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start gap-2">
              ...
              <span>
                Run <code className="bg-gray-100 px-2 py-1 rounded text-sm">bun run dev</code> for
            ...
            <li className="flex items-start gap-2">
              ...
              <span>
                Run <code className="bg-gray-100 px-2 py-1 rounded text-sm">bun run dev:hmr</code>{' '}
            ...
            <li className="flex items-start gap-2">
              ...
              <span>
                Run <code className="bg-gray-100 px-2 py-1 rounded text-sm">bun run build</code> to
        ...
        <div className="text-center text-white/80 mt-10 p-6 bg-white/10 rounded-lg backdrop-blur">
          <p>
            Edit <code className="bg-white/20 px-2 py-1 rounded text-sm">src/mainview/App.tsx</code>{' '}
